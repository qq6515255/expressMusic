      ...
      <div class="list-left">
        ...
        >
          ...
          <el-submenu index="2">
            ...
            <el-menu-item-group>
              <router-link to="/admin_category"
                ><el-menu-item index="2-1"
                  ><i class="el-icon-menu"></i>分类列表</el-menu-item
                ></router-link
              >
              <router-link to="/admin_category_add"
                ><el-menu-item index="2-2"
                  ><i class="el-icon-plus"></i>分类增加</el-menu-item
                ></router-link
              >
              <router-link to="/admin_category_update"
                ><el-menu-item index="2-3"
                  ><i class="el-icon-edit"></i>分类修改</el-menu-item
                ></router-link
              >
            </el-menu-item-group>
          </el-submenu>
            ...
            <el-menu-item-group>
              <router-link to="/admin_article"
                ><el-menu-item index="3-1"
                  ><i class="el-icon-menu"></i>内容列表</el-menu-item
                ></router-link
              >
              <router-link to="/admin_article_add"
          ...
          <el-submenu index="4">
            ...
            <el-menu-item-group>
              <router-link to="/admin_banner"
                ...
                ></router-link
              >
              <router-link to="/admin_banner_add"
                ><el-menu-item index="4-2"
                  ><i class="el-icon-menu"></i>新增轮播图</el-menu-item
                ></router-link
              >
            </el-menu-item-group>
          </el-submenu>
